    ...
    compiler.plugin('emit', function (compilation, callback) {
        ...
        Promise.resolve()
            ...
            .then(function (result) {
                ...
                var assetTags = self.generateAssetTags(assets, self.options.frontCache);
 ...
 */
HtmlWebpackPlugin.prototype.generateAssetTags = function (assets, supportCache) {
    ...
    var scripts = assets.js.map(function (scriptPath) {
        ...
        var result = {
            ...
            attributes: {
                ...
                ls_id: supportCache ? scriptPath : ''
            },
            innerHTML: supportCache ? htmlContent : ''
        };
        !supportCache && (result.attributes.src = scriptPath);
        return result;
    });
    ...
    if (supportCache) {
        ...
        var cacheStyles = assets.css.map(function (stylePath) {
            var htmlContent = '';
            var lsId = '"' + stylePath + '"';
            var quotLsId = lsId.replace(/\"/g, '\'');
...
HtmlWebpackPlugin.prototype.injectAssetsIntoHtml = function (html, assets, assetTags) {
    ...
    var head = assetTags.head.map(this.createHtmlTag);
        // console.log('the origin html')
        // console.log(html)
        // console.log('the assert tags')
        // console.log(assetTags)
        // console.log('the asserts')
        // console.log(assets)
...
HtmlWebpackPlugin.prototype.createHtmlTag = function (tagDefinition) {
        // tagDefinition: { tagName: 'script', closeTag: true, attributes: [Object]}
        // console.log(JSON.stringify(tagDefinition.attributes))
        // {"type":"text/javascript","src":"/insPage/static/js/manifest.c37b1c97c7bc7fe4ea75.js"}
        // {"href":"/insPage/static/css/awaken.7d6e5d5352e961b444253ed39752266a.css","rel":"stylesheet"}
...
// 将外部引入的js代码做缓存处理
HtmlWebpackPlugin.prototype.insertCacheCode = function () {
        // 相对于正常流程就是需要改造tagDefinition，去掉src，把引用逻辑引入到innerHTML
        // 对tagDefinition.innerHTML进行处理，同时对src进行处理
};
